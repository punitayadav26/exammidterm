         ...
         {cart.length?cart.map((item, index)=>{
          ...
          return( <div className='cartProduct-card' key={index}>
                    ...
                    <div className='cart-product-image-container'>
                         <img className='cart-pro-image' src={item.image} alt='product'/>
                    </div>
    
                    <div className='cart-product-details'> 
                        <p className='cart-product-title'>Brand, <br/><span>{item.title}</span></p>  
                        <div className='cart-price-tag'>$&nbsp;{item.price}</div>
    
                    </div>
                         
                    <div className='delete-btn'>
                       <button onClick={()=>addToCart(item)} className="deleteToCart">
